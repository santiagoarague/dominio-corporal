...
import { sdcAnimoOn, sdcAnimoHoy, sdcAbrirCard, AnimoAntes, AnimoDespues } from "../animo.jsx";
import {
  sdcCalor,
  sdcCalorDer,
  sdcPasoEspera,
...
import { IconoDestello, IconoLlama, IconoEspadas, IconoCheck, IconoReloj } from "../iconos.jsx";
...
export function PestanaEntreno({
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
              ...
              {[1, 2, 3, 4, 5, 6, 7].map((f) => (
                <button
                  ...
                  style={{
                    ...
                    border:
                      "1px solid " + (metaSemana === f ? "#3ecf8e" : "rgba(255,255,255,0.15)"),
      ...
      >
        ...
        {atributos.gap >= 2 && (
          ...
          >
            ...
            {gruposCuerpo[atributos.lo].label.toLowerCase()}. Prioriza ese patrón para emparejarlo.
          </div>
        )}
        {(() => {
          let f = grupos
      ...
      {today.completed ? (
        ...
        >
          ...
          <FilaEjercicio
            ...
            kgPrev={
              modalidad === "gym" ? (sdcGymUlt(player)[sdcEjNom("abs")] || {}).kgs || null : null
            }
            sug={
              modalidad === "gym"
                ? {
      ...
      >
        <div className="text-xs mb-3" style={{ color: "#9aa4bd" }}>
          Es lo que más rápido cambia de todo lo que hacés acá: en pocas semanas llegás más lejos y
          lo notás en el cuerpo. Dos veces por semana te dan +10% de XP la semana siguiente.
        </div>
        {(() => {
        ...
        {today.stretchDone ? (
          ...
          (() => {
            let ps = sdcEstPasos,
              ...
              esp =
                p.prep > 0 && sdcEstOk < p.index && sdcPasoEspera(ps, p.index, sdcPasosV(player));
            return (
              <PasoGuiado
                ls={ps}
                p={p}
          ...
          <>
            ...
            <div className="text-xs" style={{ color: "#7a83a0" }}>
              ...
              Listo. Un sonido grave avisa que te prepares y uno agudo que empieces, y la pantalla
              no se apaga.
            </div>
          </>
        )}
