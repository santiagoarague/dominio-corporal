...
import { neuroInicial } from "./salud.js";
...
var guia = [
    ...
    },
    {
      ...
      text: "Las repeticiones de cada patrón vienen partidas en dos o tres series, y cada serie es un botón. Tocalo apenas terminás esa serie, no al final de todo: la app suena, vibra, te suma la XP y te arranca el descanso, que queda fijo abajo de la pantalla. Si marcaste una por error, tocala otra vez y se desmarca solo esa; MARCAR TODAS y DESMARCAR TODAS hacen todo de una vez. Cuando terminás todas las series de un ejercicio, se pliega: tocalo para abrirlo de nuevo. Si una serie te salió más corta de lo pedido, tocá el − N + de la serie que queda pendiente y anotá lo que hiciste de verdad. Si ya sabés cómo vas a repartirlas (15, 15 y 12, por ejemplo), tocá «Ajustar series»: cada serie tiene su + y su −, y después las marcás una por una o todas juntas. Lo que se guarda es lo que hiciste, no lo que decía la meta. Si entrenás en gimnasio, debajo de las series vas a ver un campo de kilos para cada una: podés subir el peso serie a serie, y la próxima vez la app te recuerda lo que usaste la última.",
    },
    {
      g: "PARA EMPEZAR",
      title: "Tu semana",
      text: "Vos elegís cuántas sesiones querés hacer por semana. Cuenta como sesión la rutina (desde la mitad de las repeticiones), una travesía, ganar un combate, una sesión de Instinto Primal o terminar una expedición: cualquiera de ellas marca el día como entrenado. Si registrás menos de la mitad, la XP es tuya y el día queda como si no hubieras entrenado; otra sesión ese mismo día lo hace contar. Hay dos rachas. La semanal cuenta las semanas seguidas que cumplís la meta: un día suelto sin entrenar no la corta mientras todavía llegues. La diaria cuenta los días seguidos que entrenás y te suma 2% de XP por día, hasta 30%: se corta el día que no entrenás, salvo que ese día uses tu día de descanso o te cubra un Escudo de Racha. Nunca perdés XP. Abajo de la meta están los cuadraditos de tus últimos días, cada uno con el color del tipo de día que fue; tocá cualquiera para ver qué hiciste. Con «Compartir mi semana», al final de Constancia, armás una imagen de tu semana para mandarla a quien quieras.",
    },
    {
      g: "PARA EMPEZAR",
    ...
    },
    {
      ...
      text: "El rango es tu etapa, y hay siete. Cambia dos cosas: qué versión de cada ejercicio te toca (de la más asistida a la más difícil) y cuántas repeticiones hacés; en el gimnasio las repeticiones son siempre las de tu enfoque y lo que sube es el peso. Todo el mundo empieza en el primero: la prueba inicial ajusta cuántas repeticiones hacés, no el rango. Para pasar al siguiente rango hay que llegar a cierto nivel, sumar rutinas completas en ese rango (24 en el primero, 12 más en cada uno de los siguientes) y superar el Umbral, una prueba que aparece sola: una rutina completa del rango que viene, con sus ejercicios, repartida en varias rondas encadenadas; solo podés darla un día en el que hayas completado tu rutina al 100%. En el séptimo y último rango el objetivo diario deja de salir de una tabla: es superar tu propio récord por lo menos un 1%, y si pasás siete días sin una rutina completa bajás al anterior hasta que vuelvas.",
    },
    {
      g: "CÓMO PROGRESÁS",
      title: "Tu calibre",
