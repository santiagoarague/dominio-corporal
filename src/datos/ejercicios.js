  ...
  ejerciciosPeso = {
    pushup: {
      ...
      E: [
        ...
        },
        {
          ...
          repFactor: 1.3,
          alt: "Cuanto más lejos los pies, más difícil.",
        },
        {
      ...
      C: [
        ...
        },
        {
          ...
          err: "Si pierdes la línea en la pausa, acorta el recorrido antes que la posición.",
          repFactor: 0.85,
      ...
      B: [
        ...
        },
        {
          ...
          repFactor: 0.8,
          alt: "Pies en el suelo si no tienes dónde elevarlos.",
        },
        {
          ...
          repFactor: 0.7,
          alt: "Apoya las rodillas si es demasiado.",
        },
      ],
      A: [
        {
        ...
        },
        {
          ...
          repFactor: 0.55,
          alt: "Sin nada donde elevarlos, hazlas en el suelo con la cadera bien alta.",
        },
        {
      ...
      S: [
        {
          ...
          repFactor: 0.35,
          alt: "Alternativa: flexiones a una mano con pies abiertos.",
        },
        {
        ...
        },
        {
          ...
          err: "Si el hombro se va hacia adelante, aprieta el omóplato antes de bajar.",
          repFactor: 0.3,
      ...
      Z: [
        {
          ...
          repFactor: 0.3,
          alt: "Para progresar, inclina el cuerpo cada vez más adelante, camino a la planche: el cuerpo horizontal en el aire.",
        },
        {
      ...
      E: [
        {
          ...
          err: "Si tiras solo con los brazos, junta primero los omóplatos y después dobla los codos.",
          repFactor: 1,
        ...
        },
        {
          ...
          repFactor: 1,
          alt: "Llena una mochila con libros o botellas. Sin mochila: un bolso, una funda de almohada con libros o un bidón de agua.",
        },
      ],
      D: [
        {
          ...
          repFactor: 1,
          alt: "Sin mesa ni puerta: remo con mochila cargada, torso a 45°.",
        },
        {
          ...
          repFactor: 0.9,
          alt: "Cuenta las reps por lado. Sin mochila: un bidón de agua de 5 litros o un bolso bien cargado.",
        },
        {
          ...
          repFactor: 0.85,
          alt: "Sin mesa ni puerta: remo con mochila, un segundo arriba apretando los omóplatos.",
        },
      ],
      C: [
        {
          ...
          repFactor: 1,
          alt: "Sin mesa: remo a una mano con mochila pesada.",
        },
        {
          ...
          repFactor: 0.5,
          alt: "Sin barra: remo invertido bajando lento.",
        },
        {
          ...
          err: "Si el ritmo se te escapa, cuenta en voz alta: el ritmo es el ejercicio.",
          repFactor: 0.8,
          alt: "Sin mesa: remo con mochila al mismo ritmo.",
        },
      ],
      B: [
        {
        ...
        },
        {
          ...
          repFactor: 0.8,
          alt: "Sin mesa: remo a una mano con la mochila bien cargada, torso casi paralelo al piso.",
        },
        {
          ...
          repFactor: 0.8,
          alt: "Sin barra: remo invertido bien horizontal.",
        },
      ],
      A: [
        {
        ...
        },
        {
          ...
          err: "Si en la pausa los hombros suben a las orejas, bájalos y junta los omóplatos.",
          repFactor: 0.45,
          alt: "Sin barra: remo invertido con pausa en el pecho.",
        },
        {
          ...
          repFactor: 0.4,
          alt: "Cuenta las reps por lado. Sin mesa: remo a una mano con mochila pesada, bajando en 3 segundos.",
        },
      ],
      S: [
        {
        ...
        },
        {
          ...
          repFactor: 0.3,
          alt: "Sin barra: remo invertido explosivo.",
        },
        {
          name: "Remo en palanca agrupada",
          ...
          repFactor: 0.3,
          alt: "Sin barra: remo invertido bajo una mesa con las rodillas al pecho y los pies en el aire.",
        },
      ],
      Z: [
        {
        ...
        },
        {
          ...
          pos: "Colgado con los brazos estirados del todo y el cuerpo quieto. Si te ayuda, agarra con las muñecas por encima de la barra.",
          ...
          repFactor: 0.25,
          alt: "Sin barra: remo invertido explosivo bajo una mesa firme, hasta despegar las manos.",
        },
        {
          name: "Remo en palanca completa",
          ...
          repFactor: 0.2,
          alt: "Sin barra: remo invertido a una mano con los pies sobre una silla.",
        },
      ],
    },
    squat: {
      ...
      B: [
        ...
        },
        {
          ...
          repFactor: 0.7,
          alt: "Si molesta algo, haz sentadillas profundas rápidas.",
        },
        {
          name: "Peso muerto a una pierna",
          pos: "De pie sobre una pierna, la otra algo atrás, rodilla de apoyo casi recta.",
          mov: "Baja el torso mientras la pierna libre sube atrás, hasta sentir tirón en la parte de atrás del muslo.",
      ...
      S: [
        ...
        },
        {
          ...
          repFactor: 0.35,
          alt: "Cada semana una superficie más baja. Cuenta las reps por pierna.",
        },
      ],
      Z: [
        {
          ...
          err: "Si en la bajada el torso se derrumba, acorta el recorrido antes que el ritmo.",
          repFactor: 0.3,
        },
        {
        ...
        },
        {
          ...
          err: "Si el último segundo se te va de golpe, acorta el recorrido y conserva el ritmo.",
          repFactor: 0.25,
    ...
    abs: {
      ...
      D: [
        ...
        {
          name: "Bird dog",
          pos: "A cuatro patas, manos bajo los hombros y rodillas bajo la cadera, espalda plana.",
      ...
      A: [
        {
          ...
          repFactor: 0.6,
          alt: "Cuenta 1 rep por cada 3 segundos.",
        },
        {
      ...
      S: [
        ...
        },
        {
          ...
          repFactor: 0.4,
          alt: "Sin nada firme: boca arriba, despega los hombros del suelo y baja las piernas estiradas hasta donde la lumbar siga pegada.",
        },
      ],
      Z: [
        {
    ...
    pushup: {
      ...
      D: [
        ...
        },
        {
          ...
          err: "Si el hombro molesta abajo, no bajes tanto: el recorrido se gana con el tiempo.",
          repFactor: 1,
      ...
      C: [
        {
          ...
          pos: "Acostado con los ojos bajo la barra, omóplatos juntos, pies firmes y seguros puestos.",
        ...
        },
        {
          ...
          pos: "Banco a 30 grados, omóplatos juntos, barra sobre el pecho alto.",
          mov: "Baja hasta rozar la clavícula y empuja hasta estirar los brazos.",
          err: "Si la barra baja a la mitad del pecho, estás haciendo un press plano a medias.",
          repFactor: 1,
        },
        {
      ...
      B: [
        {
          ...
          repFactor: 0.8,
          alt: "Abdomen apretado, sin arquear la lumbar.",
        },
        {
          name: "Press banca con pausa en el pecho",
          pos: "Acostado con los omóplatos juntos y los seguros puestos, barra sobre el pecho.",
      ...
      A: [
        {
          ...
          pos: "Banco a 30 grados, omóplatos juntos, con seguros o con alguien que te cuide.",
        ...
        },
        {
          ...
          pos: "Acostado, omóplatos juntos, pies firmes y seguros puestos siempre.",
      ...
      S: [
        ...
        },
        {
          ...
          pos: "Acostado, omóplatos juntos, seguros puestos y el agarre marcado siempre igual.",
        ...
        },
        {
          ...
          err: "Sube el lastre solo cuando el recorrido completo salga limpio, nunca antes.",
          repFactor: 0.4,
          alt: "Sin cinturón de lastre: una mancuerna entre los pies o una mochila con discos.",
        },
      ],
      Z: [
        {
          ...
          err: "Si el último segundo se acelera, baja la carga: el ritmo es el ejercicio.",
          repFactor: 0.35,
          alt: "4 segundos de descenso controlado.",
        },
        {
          name: "Press banca con pausa larga",
          pos: "Acostado, omóplatos juntos y apretados, seguros puestos.",
      ...
      E: [
        {
          ...
          repFactor: 1,
          alt: "Sin polea: dominadas asistidas con banda, o remo con mancuerna a una mano.",
        },
        {
          name: "Remo en máquina",
          pos: "Sentado con el pecho apoyado en la almohadilla, manos en las manijas y brazos estirados.",
          mov: "Tira hacia atrás juntando los omóplatos y vuelve sin soltar del todo.",
      ...
      D: [
        {
          ...
          mov: "Tira la manija al ombligo juntando los omóplatos y vuelve estirando los brazos.",
          err: "Si el torso se mece adelante y atrás, fíjalo: solo se mueven los brazos.",
          repFactor: 1,
          alt: "Sin polea: remo con mancuernas sentado en un banco, torso a 45 grados.",
        },
        {
        ...
        },
        {
          ...
          err: "Si doblas los codos se convierte en un jalón y la espalda deja de trabajar.",
          repFactor: 1,
          alt: "Sin polea: pullover con mancuerna.",
        },
      ],
      C: [
        {
        ...
        },
        {
          ...
          mov: "Tira hacia el pecho juntando los omóplatos y baja estirando los brazos.",
          err: "Si te enderezas para subir el peso, la espalda deja de trabajar.",
          repFactor: 0.9,
      ...
      A: [
        {
          ...
          err: "Si el recorrido se acorta con el lastre puesto, todavía es demasiado peso.",
          repFactor: 0.45,
          alt: "Añade poco peso y haz el recorrido completo. Sin cinturón de lastre: una mancuerna entre los pies o una mochila con discos.",
        },
        {
    ...
    squat: {
      E: [
        {
          ...
          repFactor: 1,
          alt: "Sin prensa: sentadilla goblet con mancuerna, o sentadilla a caja.",
        },
        {
      ...
      D: [
        ...
        },
        {
          ...
          pos: "Barra apoyada en la parte alta de la espalda, pies algo adelantados respecto de la barra.",
          ...
          repFactor: 1,
          alt: "Sin Smith: sentadilla goblet.",
        },
        {
          ...
          repFactor: 1,
          alt: "Sin barra: una mancuerna pesada sobre la cadera, o puente de glúteos a una pierna.",
        },
      ],
      C: [
        {
          name: "Sentadilla con barra",
          pos: "Barra apoyada en la parte alta de la espalda, dentro del rack y con los seguros puestos, pies al ancho de los hombros.",
        ...
        },
        {
          ...
          mov: "Lleva la cadera atrás bajando la barra pegada a la pierna hasta sentir tirón en la parte de atrás del muslo.",
      ...
      A: [
        {
          ...
          pos: "Frontal: barra apoyada en la parte de adelante de los hombros y codos altos. Peso muerto: barra en el suelo y agarre firme.",
      ...
      S: [
        ...
        },
        {
          ...
          pos: "Barra apoyada en la parte de adelante de los hombros, codos bien altos, dedos apenas debajo de la barra.",
        ...
        },
        {
          ...
          err: "Si buscas más recorrido doblando la espalda, cambiaste el ejercicio por otro peor.",
          repFactor: 0.45,
        },
      ],
      Z: [
        {
          ...
          pos: "Barra apoyada en la parte alta de la espalda, dentro del rack y con los seguros puestos.",
          mov: "Baja en 4 segundos contados hasta el fondo y sube a velocidad normal.",
          err: "Si el último segundo se te va de golpe, baja la carga: el ritmo es el ejercicio.",
          repFactor: 0.3,
        ...
        },
        {
          ...
          pos: "Barra apoyada en la parte de adelante de los hombros, codos altos, seguros del rack puestos.",
          mov: "Baja en 3 segundos contados y sube sin rebotar abajo.",
          err: "Si rebotas para salir del fondo, el ritmo no sirvió de nada.",
          repFactor: 0.3,
    ...
    abs: {
      E: [
        ...
        },
        {
          ...
          repFactor: 1,
          alt: "Sin polea: banda elástica atada a un poste, o plancha tocando el hombro contrario.",
        },
      ],
      D: [
        {
        ...
        },
        {
          ...
          repFactor: 1,
          alt: "Sin polea: crunch en el suelo.",
        },
        {
      ...
      B: [
        ...
        },
        {
          ...
          repFactor: 0.7,
          alt: "Sin rueda: barra con discos que giren y un disco en la espalda.",
        },
        {
          name: "Crunch en polea pesado",
          pos: "De rodillas frente a la polea alta, la cuerda al lado de la cara.",
          mov: "Curva la columna con recorrido corto llevando los codos hacia los muslos y vuelve.",
          err: "Si tiras con los brazos, suelta carga: el abdomen tiene que sentirlo.",
          repFactor: 0.8,
          alt: "Sin polea: crunch en el suelo con un disco detrás de la cabeza.",
        },
      ],
      A: [
        {
          ...
          err: "Si la cadera se abre hacia la polea, baja la carga: el trabajo es que el torso no gire, no empujar.",
          repFactor: 0.18,
          alt: "Que el torso no gire: 1 rep = 3 s de tensión. Sin polea: banda gruesa atada a un poste, la misma tensión.",
        },
        {
        ...
        },
        {
          ...
          repFactor: 0.18,
          alt: "1 rep = 3 segundos. Sin disco: una mochila bien cargada.",
        },
      ],
      S: [
        {
          ...
          repFactor: 0.45,
          alt: "Es la versión más difícil de la rueda. Sin rueda: una barra con discos que giren, de pie.",
        },
        {
        ...
        },
        {
          ...
          repFactor: 0.45,
          alt: "Agárrate detrás de la cabeza y mantén el cuerpo en una sola línea.",
        },
      ],
      Z: [
        {
          ...
          err: "Si la vuelta sale de golpe, acorta el recorrido y conserva el ritmo.",
          repFactor: 0.35,
        ...
        },
        {
          ...
          repFactor: 0.3,
          alt: "Sin rueda: barra con discos y los pies en un escalón.",
        },
      ],
    },
  },
  ejerciciosFlow = {
    squat: {
      ...
      A: [
        {
          name: "Underswitch",
          pos: "En posición de bestia: a cuatro patas con las rodillas flotando a un palmo del suelo.",
    ...
    pushup: {
      ...
      D: [
        {
          name: "Flexión de oso",
          pos: "En posición de bestia: a cuatro patas con las rodillas a un palmo del suelo.",
      ...
      Z: [
        ...
        },
        {
          ...
          err: "Si pierdes el equilibrio hacia adelante, corrige con los dedos, nunca con la espalda.",
          repFactor: 0.3,
          alt: "Control total en la bajada.",
        },
        {
    ...
    back: {
      E: [
        {
          ...
          err: "Si doblas los codos ya es una dominada: el movimiento es solo de los omóplatos.",
          repFactor: 1,
          alt: "Sin barra: boca abajo en el suelo, despega el pecho juntando los omóplatos.",
        },
        {
          ...
          err: "Si empujas con los pies la espalda deja de trabajar: que las piernas vayan muertas.",
          repFactor: 1,
          alt: "1 rep = 1 brazada. Sin trapos o sobre alfombra: arrastre de comando, tirando con los codos.",
        },
        {
          ...
          repFactor: 0.8,
          alt: "1 rep = 3 segundos. Sin barra: cuélgate del marco de una puerta con los pies apoyados.",
        },
      ],
      D: [
        {
          ...
          err: "Si el pecho se hunde, sácalo hacia adelante: la espalda se aprieta, no se encoge.",
          repFactor: 0.8,
          alt: "1 rep = 3 segundos. Sin barra: en el marco de una puerta con los pies apoyados, deja caer el peso y baja los hombros.",
        },
        {
          ...
          err: "Si te ayudas con las rodillas la espalda deja de tirar: deja las piernas muertas.",
          repFactor: 1,
          alt: "1 rep = 1 brazada.",
        },
        {
      ...
      C: [
        ...
        },
        {
          ...
          repFactor: 0.7,
          alt: "1 rep = 1 balanceo completo. Sin barra: arrastre de foca, tirando fuerte con los dos brazos a la vez.",
        },
        {
      ...
      B: [
        ...
        },
        {
          ...
          repFactor: 0.5,
          alt: "Sin barra: rodada hacia atrás agrupada en el suelo.",
        },
        {
          ...
          err: "Si la cadera se cae, aprieta glúteos: el cuerpo va en una sola línea.",
          repFactor: 0.5,
          alt: "Sin barra: arrastre con trapos tirando fuerte. Sobre alfombra, donde los trapos no deslizan: arrastre de comando cuesta arriba.",
        },
      ],
      A: [
        {
          ...
          repFactor: 0.4,
          alt: "Sin barra: rodada hacia atrás con las piernas estiradas, frenando con los brazos.",
        },
        {
          name: "Macaco alto",
        ...
        },
        {
          ...
          repFactor: 0.4,
          alt: "1 rep = 1 traslado. Sin barra: arrastre de comando cuesta arriba.",
        },
      ],
      S: [
        {
          name: "Palanca frontal agrupada",
          ...
          repFactor: 0.3,
          alt: "1 rep = 3 segundos. Sin barra: boca abajo, despega pecho y piernas y lleva los brazos atrás como si remaras. 1 rep = 3 segundos.",
        },
        {
        ...
        },
        {
          ...
          repFactor: 0.3,
          alt: "1 rep = 3 segundos por lado. Sin barra: del marco de una puerta a una mano, con los pies apoyados sacándoles peso.",
        },
      ],
      Z: [
        {
          name: "Palanca frontal completa",
          ...
          err: "Si la cadera se hunde, agrupa una pierna antes que romper la línea.",
          repFactor: 0.25,
          alt: "1 rep = 3 segundos. Sin barra: arrastre de foca con los pies sobre una silla, tirando solo con los brazos.",
        },
        {
        ...
        {
          name: "Skin the cat a palanca frontal",
          ...
          err: "Si pasas de largo, todavía no tienes la palanca frontal: quédate en el skin the cat.",
          repFactor: 0.25,
          alt: "1 rep = 1 pasada. Sin barra: rodada atrás con las piernas estiradas, frenando en horizontal sobre los antebrazos.",
        },
      ],
    },
    abs: {
      E: [
        {
          name: "Beast hold",
          pos: "A cuatro patas, con las manos bajo los hombros y las rodillas bajo la cadera.",
