...
- **Pruebas**: 153 automáticas (curva de XP, Umbral, buffos, deshacer, sonidos…) y 21 de punta a
...
- ~~La prueba de aptitud se guardaba sin fecha y nunca se podía ver cuánto mejoraste~~ — resuelto
  (26/09/2026). Cada prueba queda con su fecha, Perfil compara la primera con la última y cada 4
  semanas, antes de entrenar, la app propone repetirla.
...
- ~~La tarjeta del compañero con el consejo pasaba desapercibida, y funciones como «Ajustar series»
  ...
  todavía no usaste, con **Mostrame** para ir al botón. No obliga: si no lo tocás se va solo. Se
  puede elegir **una cara** en vez de perro o gato (al empezar o en Perfil), el nombre es opcional
  y se apaga en Sistemas del juego. Queda como idea, sin hacer: que en el resumen se "escape" y
  corra por la pantalla para atraparlo, donde no hay nada en juego.
...
- ~~Las explicaciones de los ejercicios repetían y usaban palabras de gimnasio~~ — resuelto
  (25/09/2026). Las tres líneas (Posición, Movimiento, Error común) ya eran cortas y se dejaron;
  la línea gris de abajo repetía lo mismo en 151 de los 252 ejercicios y ahora solo dice lo que
